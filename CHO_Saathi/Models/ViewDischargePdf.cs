...
public partial class ViewDischargePdf
{
    ...
    public long? Still1BirthType { get; set; }

    public long? Still2BirthType { get; set; }

    public long? Still3BirthType { get; set; }

    public long? Still4BirthType { get; set; }
    ...
    public long? Baby1DelPlace { get; set; }

    public long? Baby2DelPlace { get; set; }

    public long? Baby3DelPlace { get; set; }

    public long? Baby4DelPlace { get; set; }
