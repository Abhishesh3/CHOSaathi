$.fn.extend({
    treed: function (o) {
        var openedClass = 'fa-solid fa-circle-chevron-down';
        var closedClass = 'fa-solid fa-circle-chevron-right';
...
$('.tree1 .branch').each(function () {
    var icon = $(this).children('i:first');
    icon.toggleClass('fa-solid fa-circle-chevron-down  fa-solid fa-circle-chevron-right');
    $(this).children().children().toggle();
});
